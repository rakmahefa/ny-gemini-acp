...
pub struct StreamResult {
    ...
    pub tool_detection_text: String,
}

pub async fn consume(
    mut rx: tokio::sync::mpsc::Receiver<Result<String, anyhow::Error>>,
    ...
    // Cancellation is terminal at the turn boundary. Do not synthesize a
    // completed assistant stream after cancellation; the integrity emitter
    // will close any open lifecycle when the caller emits TurnCancelled.
