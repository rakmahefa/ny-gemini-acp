...
pub async fn run_turn(
    ...
    for round in 0..MAX_TURNS{
        tool_round=round; if *cancel.borrow(){span.record("outcome","cancelled");return responder.respond(PromptResponse::new(StopReason::Cancelled));}
