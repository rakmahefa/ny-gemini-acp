...
fn completed_ui_from_info(
    ...
    // Preserve non-text invocation affordances from the pre-execution ToolInfo
    // (for example the Diff for file_write/file_edit), then append the final
    // output card generated by ResultUpdate.
